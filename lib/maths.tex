...
% Order macros
\NewDocumentCommand{\upset}{ O{} m }{{\mathop{\kl[\upset]{\uparrow_{#1}}} #2}}
\knowledge{\upset}{notion}
\NewDocumentCommand{\dwset}{ O{} m }{{\mathop{\kl[\dwset]{\downarrow_{#1}}} #2}}
\knowledge{\dwset}{notion}
...
\NewDocumentCommand{\mon}{ O{M} }{\mathfrak{#1}}
\NewDocumentCommand{\pol}{ O{p} }{#1}


\newcommand{\idlGen}[1]{\withkl{\kl[\idlGen]}{\mathopen{\cmdkl{\langle}} #1 \mathclose{\cmdkl{\rangle}}}}
\knowledge{\idlGen}{notion}

\newcommand{\idl}{\mathcal{I}}

\newcommand{\MaxMon}{\mathsf{MaxMon}}
\newcommand{\MaxMonMult}{\mathsf{MultMaxMon}}

\NewDocumentCommand{\CritPairs}{ m m }{[#1 \mathrel{;} #2]}

\NewDocumentCommand{\premulteucl}{ m }{\mathrel{\kl[\premulteucl]{\to_{#1}}}}
\knowledge{\premulteucl}{notion}

\NewDocumentCommand{\multeucl}{m m}{\mathrel{\kl[\multeucl]{\to_{(#1,#2)}}}}
\knowledge{\multeucl}{notion}


\NewDocumentCommand{\lcm}{ m m }{\mathsf{lcm}(#1,#2)}

\NewDocumentCommand{\NormalForm}{ O{} m }{ \mathop{\kl[\NormalForm]{\mathsf{NF}_{#1}}}(#2) }
\knowledge{\NormalForm}{notion}
...
\NewDocumentOrdering{gdiv}{\sqsubseteq^{\mathrm{div}}_{\Grp}}{\sqsubset^{\mathrm{div}}_{\Grp}}



\newcommand{\Fix}[2]{\mathsf{Fix}_{#1}(#2)}

\newcommand{\Orbit}[2]{\mathsf{Orbits}_{#1}(#2)}
